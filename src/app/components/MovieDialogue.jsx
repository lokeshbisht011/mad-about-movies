    ...
    return (
        <div className='flex flex-col gap-4 p-10 bg-bgSoft items-center rounded-lg shadow-md'>
            ...
            <div className="flex flex-col gap-5 items-center">
                ...
                {
                    <div className='flex items-center justify-center gap-10'>
                        <button onClick={() => challengeFriendPopup(movieUrl, DIALOGUE_DESCRIPTION)} className="bg-button hover:bg-buttonHover text-white px-4 py-2 rounded-md">Challenge a friend</button>
                        {!gameCompleted && (
                        ...
                        <button onClick={() => nextMovie(router, bollywoodMovieDialogues, DIALOGUE_URL)} className="bg-button hover:bg-buttonHover text-white px-4 py-2 rounded-md">{gameCompleted ? 'Next' : 'Skip'}</button>
                    </div>
                }
            </div>
        </div>
